...
const Home: React.FC = () => {
  ...
  const nbrRiddlesSuccess = appCtx.riddles.filter(
    (riddles) => riddles.isSuccess
  ).length;
    ...
    <IonPage>
      <IonHeader>
        <IonToolbar color={'primary'}>
          <IonTitle className="ion-text-center">Beeware</IonTitle>
        </IonToolbar>
      </IonHeader>
      <IonContent>
        <IonGrid>
                ...
                <IonGrid>
                  <IonRow>
                    ...
                    <IonCol>
                      <IonCardContent>
                        <p>
                          Temps total passé sur les épreuves:{' '}
                          {timeRiddle.toFixed(2)} seconds
                        </p>
                        <p>
                          Énigmes complétés : {nbrRiddlesSuccess}/{nbrRiddles}
                        </p>
